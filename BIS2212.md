...
1. **Virtue ethic** approach
   ...
   2. guided by virtues to reach the right decision
   3. More effective than following set principles/rules
   4. CONS:
    - Does not provided guide for action
    - Cannot be worked out objectively
2. **Utilitarian** approach
   1. Choses action that has best overall consequences
   2. Finds the greatest good by balancing all interests
   3. Fits concept of value, the use of cost-benefit analysis
   4. CONS:
    - Measuring and comparing values is difficult
    - Predicting resulting benefits/harm is difficult
    - Possibility of throwing someone under the bus
3. **Fairness** approach
   1. Focuses on fair distribution of benefits/burdens
   2. Guiding principle is to treat all people the same
   3. CONS:
    - Decision can be influences by personal bias
    - Others may consider the decision unfair
4. **Common good** approach
   1. Work together for common set of values and goals
   2. Best for majority
   3. Implement system that benefit all people
   4. CONS:
    - Consensus is difficult
    - Some require to beat greater costs than others
